...
public class NotaFiscalCompra implements Serializable {
    ...
    public NotaFiscalCompra(Long id, String numeroNota, String serieNota, String descricaoObs, BigDecimal valorTotal, BigDecimal valorDesconto, BigDecimal valorIcms, Date dataCompra, Pessoa pessoa, ContaPagar contaPagar) {
        this.id = id;
